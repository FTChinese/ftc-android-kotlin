...
class WxExpireDialogFragment(private val intent: WxOAuthIntent) : DialogFragment(), AnkoLogger {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
             ...
             *
             */
            builder.setMessage(R.string.wx_refresh_token_expired)
    ...
    private fun authorize() {
        ...
        sessionManager.saveWxIntent(intent)
