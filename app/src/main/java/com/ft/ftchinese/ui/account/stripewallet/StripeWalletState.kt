...
class StripeWalletState(
    ...
    fun retrieveSetupIntent(stripe: Stripe) {
        paymentSheetSetup?.let {
            ...
            stripe.retrieveSetupIntent(
                ...
                callback = onSetupIntentRetrieved
            )
    ...
    // After stripe payment sheet succeeded, retrieve the
    // payment method associated with this setup intent.
    private val onSetupIntentRetrieved = object : ApiResultCallback<SetupIntent> {
