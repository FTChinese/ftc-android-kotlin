...
val defaultPaywall = Paywall(
    ...
    products = listOf(
        PaywallProduct(
            ...
            tier = Tier.STANDARD,
            heading = "标准会员",
            description = "专享订阅内容每日仅需{{dailyAverageOfYear}}元(或按月订阅每日{{dailyAverageOfMonth}}元)\n精选财经资讯：覆盖全球经济、金融市场与商业趋势\n中英双语内容：在中文译文与英文原文之间切换阅读\n金融英语速读训练：用FT内容提升财经英语阅读能力\n英语电台：收听FT英语音频内容\n历史文章库：阅读1天前及更早文章，覆盖逾15万篇内容",
            smallPrint = null,
            introductory = null,
            prices = listOf(
                Price(
        ...
        PaywallProduct(
            ...
            tier = Tier.PREMIUM,
            heading = "高端会员",
            description = "专享订阅内容每日仅需{{dailyAverageOfYear}}元\n享受“标准会员”所有权益\nFT商学院：精选FT深度内容，解读投资、金融市场与科技趋势\nChatFTC：搜索、解释、总结和延展讨论FT内容\nFT全球臻享：优先获取FT全球深度内容，并按您的偏好排序\n编辑精选：总编周五推荐必读内容\n高端会员专享邮件订阅服务\nFT中文网2026年度论坛门票2张",
